    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-64px)] px-4 relative overflow-hidden bg-[#050505]">
      ...
      >
        <div className="text-center mb-10 flex flex-col items-center">
          ...
          <p className="text-white/50 text-sm font-medium">Join to start watching together.</p>
        </div>
        ...
        <p className="text-center text-white/40 text-sm mt-8 font-medium">
          ...
          <Link to="/login" className="text-white hover:text-primary transition-colors underline decoration-white/20 hover:decoration-primary underline-offset-4">
            Log in here
          </Link>
        </p>
      </motion.div>
